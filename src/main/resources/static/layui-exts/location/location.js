layui.define(['layer', 'locationX'], function (exports) {
	...
	var tpl1 ='<div class="cur-load0"></div>\n' +
            '<div class="cur-load1"></div>\n' +
            '<div class="ew-map-select-tool" style="position: relative;">\n' +
            '    搜索：<input id="ew-map-select-input-search" class="layui-input icon-search inline-block"' +
        ' style="width: 190px;" placeholder="输入关键字搜索OK" autocomplete="off" />\n' +
            '    <div id="ew-map-select-tips" class="ew-map-select-search-list layui-hide" style="left: 0px;width:250px;"></div>\n' +
            '    &nbsp;&nbsp;经度：<input id="lng" class="layui-input  inline-block" style="width: 190px;" autocomplete="off" />\n' +
            '    &nbsp;&nbsp;&nbsp;纬度：<input id="lat" class="layui-input  inline-block" style="width: 190px;" autocomplete="off" />\n' +
    ...
    var obj = function (config) {
        ...
        this.config = {
            ...
            searchKey: '村',
            init: function () {
                return {longitude: 114.304569, latitude: 30.593354};
            },
            success: function () {
        ...
        this.openTiandiMap = function () {
            ...
            var latLng = new T.LngLat(o.config.longitude ? o.config.longitude : 114.304569, o.config.latitude ? o.config.latitude : 30.593354);
        ...
        this.initTiandiSearch = function (map,searchNearBy,markCenter){
            var o = this;
            searchNearBy(o.config.longitude ? o.config.longitude : 114.304569, o.config.latitude ? o.config.latitude : 30.593354);
        ...
        this.openGaodeMap = function () {
            ...
            var map = new AMap.Map("map",
                {
                    resizeEnable: true,
                    zoom: o.config.zoom,
                    center: [o.config.longitude ? o.config.longitude : 114.304569, o.config.latitude ? o.config.latitude : 30.593354],
                    layers: layers
                });
            ...
            var marker = new AMap.Marker({
                ...
                position: [o.config.longitude ? o.config.longitude : 114.304569, o.config.latitude ? o.config.latitude : 30.593354]
            });
            map.add(marker);
                ...
                var index = layer.open({
                    ...
                    success: function () {
                        ...
                        $("#ew-map-select-btn-ok").on("click", function () {
                            o.config.success({lng: o.lng ? o.lng : 114.304569, lat: o.lat ? o.lat : 30.593354});
                            layer.close(index);
                        })
                    }
                });
